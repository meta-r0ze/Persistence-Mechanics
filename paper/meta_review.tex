...
* Cohesion Optimization / Modular Consolidation: For any issues point out if it occurs because of a lack of missing [section/paragraph/sentence] solving/answering a general thing and the paper is currently compensating by smearing explanations or repetitive definition across various sections.
...
* IMPROVE: Check that the citations are correct
...
* Reviewing the paper as is.  The high level flow, names of sections, order of presentation, name of the paper and section, etc.

* Earlier drafts called this a framework, we want to make sure that phrasing wise instead this is simply writing down the universal Mechanics of Persistence.

* This is a complex systems paper. The abstract/conclusion should discuss the complex systems problem of persistence and how it presents a solution for that. This is a general presentation of the underlying mechanics for all systems that persist and should be stand alone, the validation/example is separate. 
...
* TONE: Never declare that another field is "arbitrary," "wrong," or an "axiom."
* TONE: check for Aggressive/Dismissive Language, replacing any implied critique of another field with pure emergent/dual framing.
...
* Like Shannon or E.T. Jaynes this paper is to be built on by everyone, generic in its value, not saying how to optimize a specific system, it is the abstraction layer
...
- Open-Systems & Rosetta Stone: examples from across various fields.